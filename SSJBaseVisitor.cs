...
public partial class SSJBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ISSJVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAsignation([NotNull] SSJParser.AsignationContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTerm([NotNull] SSJParser.TermContext context) { return VisitChildren(context); }
	/// <summary>
